...
//----game-ext-adjust-begin--
if (window.wx) {
    // 微信版本使用的Partner扩展实现
    window.PARTNER_EXT = "libs/partner/wechat/PartnerWechat.js";
    loadLib("libs/unzip.min.js");
} else {
    loadLib("libs/jszip.min.js");
    if (window.conchConfig) {
        var os = conchConfig.getOS();
        if(os == "Conch-ios") {
            window.PARTNER_EXT = "libs/partner/ios/PartnerIos.js";
        } else if(os == "Conch-android") {
            window.PARTNER_EXT = "libs/partner/android/PartnerAndroid.js";
        }
    }
}
//----game-ext-adjust-end--
...
(function (global, factory) {
    ...
    MixStringBuffer.prototype.setOri = function(oriStr) {
      if (!oriStr) {
        console.warn("Warning MixStringBuffer", oriStr);
      }
